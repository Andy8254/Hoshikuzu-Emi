...
The Core version of this service is designed to utilise your host machine's local resources. To minimise electricity costs and reduce your environmental footprint, we strongly recommend hosting the bot on a dedicated Raspberry Pi 5 (with a 256GB microSD/NVMe) running Ubuntu Server. Please do note that all third-party libraries listed in LICENSE.md must be installed on the host server machine before initialisation for proper use.
